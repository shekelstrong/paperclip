...
function SkillPane({
  ...
  const removeDisabledReason = removeBlocked
    ? "Отсоедините этот навык от всех агентов перед удалением."
    : null;
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            ...
            {detail.editable ? (
              ...
              >
                ...
                {editMode ? "Остановить редактирование" : "Edit"}
              </button>
            ) : (
          ...
          <div className="border-b border-border px-4 py-3">
            ...
            <div className="mt-3 flex items-center gap-2 border-b border-border pb-2">
              <input
                ...
                placeholder="Вставьте путь, URL GitHub или команду skills.sh"
                className="w-full bg-transparent text-sm outline-none placeholder:text-muted-foreground"
              />
              <Button
                size="sm"
