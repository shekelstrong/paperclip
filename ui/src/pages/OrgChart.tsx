...
export function OrgChart() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message="Выберите компанию для просмотра орг. структуры." />;
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message="Не определена организационная иерархия." />;
  }
