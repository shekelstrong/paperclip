...
export function OnboardingWizard() {
  ...
  const [taskTitle, setTaskTitle] = useState(
    "Наймите первого инженера и создайте план найма"
  );
  ...
  function reset() {
    ...
    setTaskTitle("Наймите первого инженера и создайте план найма");
  ...
  async function handleStep2Next() {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Не удалось создать агента");
    } finally {
      setLoading(false);
    }
  }
                ...
                <div className="space-y-5">
                  ...
                  <div className="group">
                    ...
                    <textarea
                      ...
                      placeholder="Чего пытается достичь эта компания?"
                      value={companyGoal}
                  ...
                  {isLocalAdapter && (
                    <div className="space-y-2 rounded-md border border-border p-3">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        >
                          {adapterEnvLoading ? "Testing..." : "Тестировать"}
                        </Button>
                      </div>
