...
function SelectЗначение({
  ...props
}: React.ComponentProps<typeof SelectPrimitive.Значение>) {
  return <SelectPrimitive.Значение data-slot="select-value" {...props} />
}
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon classИмя="size-4 opacity-50" />
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      classИмя={cn("text-muted-foreground px-2 py-1.5 text-xs", classИмя)}
      {...props}
    />
  )
}
  ...
  return (
    ...
    >
      <span
        ...
        classИмя="absolute right-2 flex size-3.5 items-center justify-center"
      >
        <SelectPrimitive.ItemIndicator>
          <CheckIcon classИмя="size-4" />
        </SelectPrimitive.ItemIndicator>
      </span>
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      classИмя={cn("bg-border pointer-events-none -mx-1 my-1 h-px", classИмя)}
      {...props}
    />
  )
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <ChevronDownIcon classИмя="size-4" />
    </SelectPrimitive.ScrollDownButton>
  )
}
