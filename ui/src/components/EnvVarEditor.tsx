...
export function EnvVarEditor({
  ...
  async function sealRow(index: number) {
    ...
    try {
      ...
      setSealError(error instanceof Error ? error.message : "Не удалось создать секрет");
    }
  }
            ...
            {row.source === "secret" ? (
              <>
                ...
                <button
                  ...
                  title="Создать секрет из текущего обычного значения"
                >
                  New
                </button>
              </>
              ...
              <>
                ...
                <button
                  ...
                  onClick={() => sealRow(index)}
                  disabled={!row.key.trim() || !row.plainValue}
                  title="Сохранить значение как секрет и заменить на референс"
                >
                  Seal
                </button>
              </>
