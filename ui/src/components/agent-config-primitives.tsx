...
export const help: Record<string, string> = {
  ...
  model: "Переопределить модель по умолчанию, используемую адаптером.",
  thinkingEffort: "Control model reasoning depth. Supported values vary by adapter/model.",
  chrome: "Enable Claude's Chrome integration by passing --chrome.",
  dangerouslySkipPermissions: "Запускать без присмотра с авто-утверждением запросов разрешений адаптера, если поддерживается.",
  dangerouslyBypassSandbox: "Run Codex without sandbox restrictions. Required for filesystem/network access.",
  search: "Включить возможность веб-поиска Codex во время запусков.",
  ...
  workspaceBaseRef: "Базовый git-реф для создания ветки worktree. Оставьте пустым для использования рефа рабочего пространства или HEAD.",
  ...
  payloadTemplateJson: "Опциональный JSON, объединяемый с удалёнными запросами адаптера перед стандартными полями Paperclip.",
  webhookUrl: "URL, который получает POST-запросы при вызове агента.",
  ...
  intervalSec: "Секунд между автоматическими heartbeat вызовами.",
  timeoutSec: "Максимальное время запуска в секундах до принудительного завершения. 0 означает без таймаута.",
  graceSec: "Секунд ожидания после отправки interrupt перед force-killing процесса.",
  wakeOnDemand: "Разрешить пробуждение агента назначениями, API-вызовами, UI-действиями или автоматизированными системами.",
  cooldownSec: "Минимальное количество секунд между последовательными heartbeat запусками.",
  ...
  maxTurnContinuationMaxAttempts: "Максимум автоматических продолжений после остановки по max-turn. Это отдельно от max turns per run.",
  maxTurnContinuationDelaySec: "Секунд ожидания перед началом каждого max-turn continuation.",
  budgetMonthlyCents: "Ежемесячный лимит расходов в центах. 0 означает без лимита.",
};
